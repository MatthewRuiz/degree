...
public class Candidate extends Element
{
   ...
   */
   ...
   {
      if(obj.getClass().getName().equals("Candidate"))
         if(name.equals(((Candidate) obj).name))  
            return true;
   ...
   */
   ...
   /**
      Needed to satisfy the promise between the abstract Element class and the calling Candidate class
   */
