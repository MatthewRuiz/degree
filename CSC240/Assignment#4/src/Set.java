 ...
 /**
   The removeAnObject method will search for an object, aT, in the Set. If found, it will then 
   remove the object from the set.If not, it will return false meaning that the object was not in the Set.
   @param aT The object we attempt to remove
   @return false if the object was not in the Set
           True is the object was successfully removed
...
/**
   The retrieveAnObject method will search for the object, aT, in the Set. If found, it will then 
   return a reference to that object in the Set. If it does not find aT, it will return null.
   @param aT The object we attempt to retrieve
   @return null if the object was not found in the Set
